...
@section('title', 'Semua Artikel - IDN Menulis')
@section('meta_title', 'Semua Artikel - IDN Menulis')
@section('meta_description', 'Jelajahi semua artikel terbaru di IDN Menulis. Temukan inspirasi dari ribuan artikel yang ditulis oleh penulis berbakat Indonesia.')
@section('content')
    <!-- Hero Header -->
    <section class="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl lg:text-5xl font-bold font-display text-white mb-4">Jelajahi Artikel</h1>
            <p class="text-primary-100 text-lg max-w-2xl mx-auto">Temukan inspirasi dari ribuan artikel yang ditulis oleh
                penulis berbakat Indonesia</p>
        </div>
    </section>
                    ...
                    <div class="space-y-2">
                        @foreach($categories as $category)
                            <a href="{{ route('categories.show', $category->slug) }}"
                                class="flex items-center justify-between p-3 rounded-xl hover:bg-primary-50 transition-colors group">
                                <div class="flex items-center gap-3">
                                    <span class="text-xl">{{ $category->icon ?? '📁' }}</span>
                                    <span
                                        class="font-medium text-gray-700 group-hover:text-primary-600">{{ $category->name }}</span>
                                </div>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="lg:hidden bg-white rounded-2xl p-4 shadow-sm mb-6">
                    <form action="{{ route('articles.search') }}" method="GET" class="flex gap-2">
                        ...
                        <button type="submit"
                            class="px-4 py-2.5 bg-primary-500 text-white rounded-xl hover:bg-primary-600 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                ...
                <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <article
                            ...
                            <div class="relative h-48 overflow-hidden">
                                ...
                                <div class="absolute top-3 right-3">
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded-lg text-xs text-white">
                    ...
                    @empty
                        <div class="col-span-full py-16 text-center">
                            ...
                            <p class="text-gray-500 mb-6">Jadilah yang pertama menulis artikel di platform ini!</p>
