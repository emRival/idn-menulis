...
<section class="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-primary-100 text-lg max-w-2xl mx-auto">Temukan inspirasi dari ribuan artikel yang ditulis oleh penulis berbakat Indonesia</p>
    </div>
</section>
                    ...
                    <a href="{{ route('categories.show', $category->slug) }}"
                       class="flex items-center justify-between p-3 rounded-xl hover:bg-primary-50 transition-colors group">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-gray-700 group-hover:text-primary-600">{{ $category->name }}</span>
                        </div>
