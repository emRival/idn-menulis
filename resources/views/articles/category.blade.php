...
@section('meta_title', $category->name . ' - IDN Menulis')
@section('meta_description', 'Baca artikel terbaru dalam kategori ' . $category->name . ' di IDN Menulis.')
@section('content')
    <!-- Hero Header -->
                        ...
                        @foreach($categories as $cat)
                            <a href="{{ route('categories.show', $cat->slug) }}"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="font-medium {{ $cat->id === $category->id ? 'text-primary-600' : 'text-gray-700 group-hover:text-primary-600' }}">{{ $cat->name }}</span>
                                </div>
                                <span
                                    class="text-sm {{ $cat->id === $category->id ? 'text-primary-500' : 'text-gray-400' }}">{{ $cat->articles_count }}</span>
                            </a>
                        @endforeach
                    </div>
                </div>
