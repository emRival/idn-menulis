...
@section('content')
    ...
    <section class="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-4xl lg:text-5xl font-bold font-display text-white mb-4">{{ $tag->name }}</h1>
            <p class="text-primary-100 text-lg max-w-2xl mx-auto">Menampilkan artikel dengan tag #{{ $tag->name }}</p>
        </div>
    </section>
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach($tags as $t)
                            <a href="{{ route('tags.show', $t->slug) }}"
                                class="px-3 py-1.5 rounded-lg text-sm transition-colors {{ $t->id === $tag->id ? 'bg-primary-100 text-primary-700 font-medium' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 hover:text-gray-900' }}">
                                #{{ $t->name }}
                            </a>
                        @endforeach
                    </div>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <nav class="hidden sm:flex items-center gap-2 text-sm">
                        <a href="{{ route('home') }}"
                            class="text-gray-500 hover:text-primary-500 transition-colors">Beranda</a>
                ...
                <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6">
                            ...
                            <div class="relative h-48 overflow-hidden">
                                ...
                                @else
                                    <div
                                        ...
                                        <span class="text-6xl opacity-50 text-white">#</span>
                                    </div>
                                @endif
                    ...
                    @empty
                        <div class="col-span-full py-16 text-center">
                            ...
                            <p class="text-gray-500 mb-6">Belum ada artikel dengan tag #{{ $tag->name }}</p>
                            @auth
