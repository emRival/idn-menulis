...
@section('content')
    <div x-data="userDetailPage()" class="min-h-screen bg-gray-50">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm text-center">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ $user->articles->sum(fn($a) => $a->likedBy()->count()) }}
                            </p>
        ...
        <!-- Change Role Modal -->
        <template x-teleport="body">
            <div x-show="showChangeRoleModal" x-cloak class="fixed inset-0 z-[100] overflow-y-auto"
                aria-labelledby="modal-title" role="dialog" aria-modal="true">
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <!-- Suspend Modal -->
        <template x-teleport="body">
            <div x-show="showSuspendModal" x-cloak class="fixed inset-0 z-[100] overflow-y-auto"
                aria-labelledby="modal-title" role="dialog" aria-modal="true">
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div class="bg-white px-6 pt-6 pb-4">
                            ...
                            <div class="mt-4">
                                <p class="text-gray-600 text-sm">Anda yakin ingin menghapus akun <span
                                        class="font-semibold text-gray-900">{{ $user->full_name }}</span>? Semua data
                                    terkait
        ...
        <!-- Notification Modal -->
        <template x-teleport="body">
            <div x-show="showNotificationModal" x-cloak class="fixed inset-0 z-[100] overflow-y-auto"
                aria-labelledby="modal-title" role="dialog" aria-modal="true">
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
