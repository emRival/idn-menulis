    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6"
                x-data="{ role: '{{ old('role', $user->role) }}', is_active: {{ old('is_active', $user->is_active) ? 'true' : 'false' }} }">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        <div class="grid md:grid-cols-2 gap-5">
                            <!-- Full Name -->
                            <div>
                                <label for="full_name" class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap
                            ...
                            <!-- Username -->
                            <div>
                                <label for="username" class="block text-sm font-medium text-gray-700 mb-2">Username <span
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        <!-- Role Selection -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-3">Role Pengguna <span
                                    class="text-red-500">*</span></label>
                            <div class="grid md:grid-cols-3 gap-4">
                                <label
                                    class="relative flex items-center gap-3 p-4 border rounded-xl cursor-pointer hover:bg-gray-50 transition-colors group"
                                    :class="{ 'border-emerald-400 bg-emerald-50': role === 'siswa', 'border-gray-200': role !== 'siswa' }">
                                    <input type="radio" name="role" value="siswa" class="peer sr-only" x-model="role"
                                        required>
                                ...
                                <label
                                    ...
                                    <input type="radio" name="role" value="guru" class="peer sr-only" x-model="role">
                        ...
                        <div class="grid md:grid-cols-2 gap-5">
                            ...
                            <!-- Sekolah -->
                            <div>
                                <label for="school_name" class="block text-sm font-medium text-gray-700 mb-2">Nama
                                    Sekolah</label>
                ...
                <div class="flex items-center justify-end gap-4">
                    ...
                    <button type="submit"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/25">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
