    ...
    <div class="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('approvals.pending') }}"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium transition-colors">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <!-- Pending Review -->
                <div
                    class="bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl shadow-lg p-5 text-white relative overflow-hidden">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div class="text-center p-4 rounded-xl bg-blue-50">
                        <p class="text-3xl font-bold text-blue-600">
                            {{ $stats['total_approved'] + $stats['total_rejected'] }}</p>
            ...
            <div class="grid grid-cols-3 gap-4 mb-8">
                <a href="{{ route('approvals.pending') }}"
                    class="group bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-lg hover:border-emerald-200 transition-all text-center">
                    <div
                        class="w-14 h-14 rounded-xl bg-emerald-50 group-hover:bg-emerald-100 flex items-center justify-center mx-auto mb-3 transition-colors">
                ...
                <a href="#"
                    class="group bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-lg hover:border-blue-200 transition-all text-center">
                    <div
                        class="w-14 h-14 rounded-xl bg-blue-50 group-hover:bg-blue-100 flex items-center justify-center mx-auto mb-3 transition-colors">
                ...
                <a href="{{ route('articles.index') }}"
                    class="group bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-lg hover:border-purple-200 transition-all text-center">
                    <div
                        class="w-14 h-14 rounded-xl bg-purple-50 group-hover:bg-purple-100 flex items-center justify-center mx-auto mb-3 transition-colors">
                        ...
                        <div class="divide-y divide-gray-50">
                            @forelse($pendingArticles as $article)
                                <a href="{{ route('approvals.show', $article->id) }}"
                                    class="block px-6 py-4 hover:bg-emerald-50/50 transition-colors">
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center gap-2 mt-2 text-sm text-gray-500">
                                                <div class="flex items-center gap-1">
                                                    <div
                                                        class="w-5 h-5 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center">
                                                        <span
                                                            class="text-white text-xs font-medium">{{ substr($article->user->full_name, 0, 1) }}</span>
                                                    </div>
                                        ...
                                        <button
                                            class="flex-shrink-0 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium transition-colors">
                                            Review
                                        </button>
                                    </div>
                                </a>
                        ...
                        <div class="divide-y divide-gray-50">
                            @forelse($topAuthors as $index => $author)
                                <div class="px-6 py-4 flex items-center gap-4">
                                    <div class="relative">
                                        <div
                                            class="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center">
                                            <span
                                                class="text-white text-sm font-bold">{{ substr($author->full_name, 0, 1) }}</span>
                                        </div>
                                        @if($index < 3)
